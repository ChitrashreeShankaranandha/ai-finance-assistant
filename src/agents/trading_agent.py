...
def simulated_buy(ticker: str, shares: float):
    """
    Simulates buying shares using cash in demo portfolio.
    """
...
def simulated_sell(ticker: str, shares: float):
    """
    Simulates selling shares from demo portfolio.
    """
